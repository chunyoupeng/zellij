...
#[derive(Clone, PartialEq, ::prost::Oneof)]
    pub enum ActionType {
        ...
        ToggleCopyMode(super::ToggleCopyModeAction),
        #[prost(message, tag="149")]
        CopyModeMove(super::CopyModeMoveAction),
        #[prost(message, tag="150")]
        CopyModePageScroll(super::CopyModePageScrollAction),
        #[prost(message, tag="151")]
        CopyModeHalfPageScroll(super::CopyModeHalfPageScrollAction),
        #[prost(message, tag="152")]
        CopyModeLineStart(super::CopyModeLineStartAction),
        #[prost(message, tag="153")]
        CopyModeLineEnd(super::CopyModeLineEndAction),
        #[prost(message, tag="159")]
        CopyModeLineSelect(super::CopyModeLineSelectAction),
        #[prost(message, tag="154")]
        CopyModeWordStart(super::CopyModeWordStartAction),
        #[prost(message, tag="155")]
        CopyModeWordEnd(super::CopyModeWordEndAction),
        #[prost(message, tag="156")]
        CopyModeWordBack(super::CopyModeWordBackAction),
        #[prost(message, tag="157")]
        CopyModeYank(super::CopyModeYankAction),
        #[prost(message, tag="158")]
        CopyModeCancel(super::CopyModeCancelAction),
    }
}
...
#[allow(clippy::derive_partial_eq_without_eq)]
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct SetPaneFrameStyleAction {
    #[prost(string, tag="1")]
...
#[allow(clippy::derive_partial_eq_without_eq)]
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct ToggleCopyModeAction {
}
#[allow(clippy::derive_partial_eq_without_eq)]
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct CopyModeMoveAction {
    #[prost(enumeration="Direction", tag="1")]
    pub direction: i32,
}
#[allow(clippy::derive_partial_eq_without_eq)]
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct CopyModePageScrollAction {
    #[prost(enumeration="Direction", tag="1")]
    pub direction: i32,
}
#[allow(clippy::derive_partial_eq_without_eq)]
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct CopyModeHalfPageScrollAction {
    #[prost(enumeration="Direction", tag="1")]
    pub direction: i32,
}
#[allow(clippy::derive_partial_eq_without_eq)]
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct CopyModeLineStartAction {
}
#[allow(clippy::derive_partial_eq_without_eq)]
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct CopyModeLineEndAction {
}
#[allow(clippy::derive_partial_eq_without_eq)]
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct CopyModeLineSelectAction {
}
#[allow(clippy::derive_partial_eq_without_eq)]
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct CopyModeWordStartAction {
}
#[allow(clippy::derive_partial_eq_without_eq)]
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct CopyModeWordEndAction {
}
#[allow(clippy::derive_partial_eq_without_eq)]
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct CopyModeWordBackAction {
}
#[allow(clippy::derive_partial_eq_without_eq)]
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct CopyModeYankAction {
}
#[allow(clippy::derive_partial_eq_without_eq)]
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct CopyModeCancelAction {
}
#[allow(clippy::derive_partial_eq_without_eq)]
#[derive(Clone, PartialEq, ::prost::Message)]
